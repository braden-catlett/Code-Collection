...
public class JavaLibraryExceptionsTestCase extends TestCase {
	...
	// verifico che java_object(ClassName, ArgList, ObjId) lancia una
	// Exception se ObjId già riferisce un altro oggetto nel sistema
	...
	// verifico che java_class(ClassSourceText, FullClassName, ClassPathList,
	// ObjId) lancia una ClassNotFoundException se la classe non può essere
	// localizzata nella gerarchia dei package così come specificato
	...
	// verifico che java_array_set(ObjArrayId, Index, ObjId) lancia una
	// IllegalArgumentException se ObjId non è un valore corretto
