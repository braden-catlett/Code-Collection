	...
	foreach ($x->children() as $child)
	{
	   ...
	   else if ($child->getName() == "cat")
	   {
		  ...
		  if ($profid != "")
		  {
			 if ($child["act"] == "0")
			 {
				$sql = "DELETE FROM ProfilePreferences WHERE ProfileID=".$profid." AND PrefID=".$catid.";";
			 }
			 else
			 {
				$sql = "INSERT INTO ProfilePreferences VALUES (".$profid.", ".$catid.");";
			 }
